          ...
          try {
            ...
            if (parsedData) {
              onDataUpdate({
                ...
                askVolumes: {
                  askp_rsqn1: parsedData.stocks.askpRsqn1,
                  askp_rsqn3: parsedData.stocks.askpRsqn3,
                  askp_rsqn5: parsedData.stocks.askpRsqn5,
                  askp_rsqn7: parsedData.stocks.askpRsqn7,
                  askp_rsqn9: parsedData.stocks.askpRsqn9,
                  askp_rsqn10: parsedData.stocks.askpRsqn10,
                },
                bidVolumes: {
                  bidp_rsqn1: parsedData.stocks.bidpRsqn1,
                  bidp_rsqn3: parsedData.stocks.bidpRsqn3,
                  bidp_rsqn5: parsedData.stocks.bidpRsqn5,
                  bidp_rsqn7: parsedData.stocks.bidpRsqn7,
                  bidp_rsqn9: parsedData.stocks.bidpRsqn9,
                  bidp_rsqn10: parsedData.stocks.bidpRsqn10,
                },
