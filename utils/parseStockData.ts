 ...
 * rawData 양식
 * 0|H0STCNT0|004|005930^093354^71900^5^-100^-0.14^72023.83^72100^72400^71700^71900^71800^1^3052
 ...
 * 
 */
export function parseStockData(rawData: string): Record<string, string>[] {
  ...
  // [dataCount][REQUIRED_STOCK_FILED.length]
